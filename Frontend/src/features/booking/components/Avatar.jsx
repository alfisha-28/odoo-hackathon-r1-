...
export default function Avatar({ name = '', avatarUrl = '', size = 'md' }) {
  ...
  // We don't actually have real avatar files in /avatars, so we will show a beautiful letter circle
  // styled with a persistent custom background color depending on the letter code
  ...
  return (
    ...
    >
      {/* Since we have mock images path, let's just render the initials for standard high-fidelity rendering, or render image if present */}
