...
export default function UtilizationChart({ data = [], isLoading = false }) {
  if (isLoading) {
    return (
      <div className="bg-white border border-[#E5E7EB] rounded-2xl p-6 shadow-sm h-[380px] flex items-center justify-center">
        <div className="flex flex-col items-center gap-3">
          ...
          <span className="text-xs font-bold text-[#6B7280]">Loading utilization data...</span>
        </div>
      </div>
    );
  }
  ...
  return (
    <div className="bg-white border border-[#E5E7EB] rounded-2xl p-6 shadow-sm select-none flex flex-col gap-4 text-left w-full h-[380px]">
      <div className="flex justify-between items-center">
        <h3 className="text-sm font-black text-[#111827]">Asset Utilization Overview</h3>
      </div>
