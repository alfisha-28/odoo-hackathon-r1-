...
export default function Pagination({
  ...
  // Helper to generate page number buttons array
  ...
  return (
    <div className="flex flex-col sm:flex-row items-center justify-between gap-4 py-4 px-6 select-none bg-white border border-[#E5E7EB] rounded-2xl shadow-sm">
      ...
      <div className="text-xs font-bold text-[#6B7280]">
        ...
        <span className="text-[#111827]">{totalItems}</span> assets
      </div>
      ...
      <div className="flex items-center gap-4">
        ...
        <div className="relative">
          <select
            ...
            className="h-8 bg-white border border-[#E5E7EB] rounded-lg pl-3 pr-8 text-xs font-bold text-[#475569] focus:outline-none focus:border-[#7C3AED] appearance-none cursor-pointer select-none transition-colors"
          >
